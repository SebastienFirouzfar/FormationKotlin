 ...
 */
class PocketFragment : Fragment(),MovieAdapter.AdapterListerner, DataRepository.PocketUIListener{
    ...
    override fun onStart() {
        ...
        if (myContext != null) {
            DataRepository.instance.getPagePocket(myContext, currentPage)
        }
    }
    ...
    override fun  updateUI() {
        ...
        val page= DataRepository.instance.pagePocket
        if (page != null){
            pageMovies= page
